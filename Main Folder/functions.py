        ...
        for met in met_regions:
            for tight in tight_selections:
                for iso in isolation_variations:
                    sample[0][cr][met][tight][iso]['Na'] = d*sample[1][cr][met][tight][iso]['Na'] #a*sample[0][cr][met][tight][iso]['Na'] #+ d*sample[1][cr][met][tight][iso]['Na'] + e*sample[2][cr][met][tight][iso]['Na']
                    sample[0][cr][met][tight][iso]['Nb'] = d*sample[1][cr][met][tight][iso]['Nb'] #a*sample[0][cr][met][tight][iso]['Nb'] #+ d*sample[1][cr][met][tight][iso]['Nb'] + e*sample[2][cr][met][tight][iso]['Nb']
    
    for tight in tight_selections:
        for iso in isolation_variations:
            sample[0]['gammajetCR'][tight][iso]['Na'] = d*sample[1]['gammajetCR'][tight][iso]['Na'] #a*sample[0]['gammajetCR'][tight][iso]['Na'] #+ d*sample[1]['gammajetCR'][tight][iso]['Na'] + e*sample[2]['gammajetCR'][tight][iso]['Na']
            sample[0]['gammajetCR'][tight][iso]['Nb'] = d*sample[1]['gammajetCR'][tight][iso]['Nb'] #a*sample[0]['gammajetCR'][tight][iso]['Nb'] #+ d*sample[1]['gammajetCR'][tight][iso]['Nb'] + e*sample[2]['gammajetCR'][tight][iso]['Nb']
