...
// Tue Mar  5 14:44:52 2019 by ROOT version 6.14/04
// from TTree gammajets/
...
public :
   ...
   TTreeReaderArray<float> ph_Rphi = {fReader, "ph_Rphi"};
   TTreeReaderArray<float> ph_weta2 = {fReader, "ph_weta2"};
   TTreeReaderArray<float> ph_fracs1 = {fReader, "ph_fracs1"};
   TTreeReaderArray<float> ph_weta1 = {fReader, "ph_weta1"};
   TTreeReaderArray<float> ph_emaxs1 = {fReader, "ph_emaxs1"};
   TTreeReaderArray<float> ph_f1 = {fReader, "ph_f1"};
   TTreeReaderArray<float> ph_Reta = {fReader, "ph_Reta"};
   TTreeReaderArray<float> ph_wtots1 = {fReader, "ph_wtots1"};
   TTreeReaderArray<float> ph_Eratio = {fReader, "ph_Eratio"};
   TTreeReaderArray<float> ph_Rhad = {fReader, "ph_Rhad"};
   TTreeReaderArray<float> ph_Rhad1 = {fReader, "ph_Rhad1"};
   TTreeReaderArray<float> ph_e277 = {fReader, "ph_e277"};
   TTreeReaderArray<float> ph_deltae = {fReader, "ph_deltae"};
   ...
   TTreeReaderValue<Float_t> mc_weight_sumn = {fReader, "mc_weight_sum"};
