#define Selector_fondo_cxx
// The class definition in Selector_fondo.h has been generated automatically
...
//
// root> T->Process("Selector_fondo.C")
// root> T->Process("Selector_fondo.C","some options")
// root> T->Process("Selector_fondo.C+")
//


#include <Selector_fondo.h>
#include <TH2.h>
#include <TStyle.h>
#include <iostream>
#include <TH1F.h>
...
void Selector_fondo::Begin(TTree * /*tree*/)
{
...
void Selector_fondo::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t Selector_fondo::Process(Long64_t entry)
{
...
void Selector_fondo::SlaveTerminate()
{
...
void Selector_fondo::FillGraphs(TH2F **g, int i, Float_t met) {
...
void Selector_fondo::FillGraphs(TH2F *g, int i) {
