#define Selector_segnale_cxx
// The class definition in Selector_segnale.h has been generated automatically
...
//
// root> T->Process("Selector_segnale.C")
// root> T->Process("Selector_segnale.C","some options")
// root> T->Process("Selector_segnale.C+")
//


#include <Selector_segnale.h>
#include <TH2.h>
#include <TStyle.h>
#include <iostream>
#include <TH1F.h>
...
void Selector_segnale::Begin(TTree * /*tree*/)
{
...
void Selector_segnale::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t Selector_segnale::Process(Long64_t entry)
{
   ...
   for (int i = 0, n =  ph_pt.GetSize(); i < n; ++i) {
      ...
      if(*trigger_HLT_g140_loose==1)
         ...
         if(true)//*met_nomuon_tst_et>150000.)
   ...
   for (int i = 0, n =  ph_pt.GetSize(); i < n; ++i) {
      ...
      if(*trigger_HLT_g140_loose==1) 
         ...
         if(true)//*met_noelectron_tst_et>150000.) 
   ...
   for (int i = 0, n =  ph_pt.GetSize(); i < n; ++i) {
      ...
      if(*trigger_HLT_g140_loose==1) 
         ...
         if(true)//*met_tst_et > 85000. && *met_tst_et<110000) 
...
void Selector_segnale::SlaveTerminate()
{
...
void Selector_segnale::Terminate()
{
...
void Selector_segnale::FillGraphs(TH2F **g, int i, Float_t met) {
...
void Selector_segnale::FillGraphs(TH2F *g, int i) {
