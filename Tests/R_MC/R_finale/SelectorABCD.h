...
MET cut: met_tst_et > 150000 MeV
ph cut: ph_pt > 150000 MeV && abs(ph_eta2) < 2.37 && (abs(ph_eta2) < 1.37 || abs(ph_eta2) > 1.52)
MET sig: met_tst_sig_old > 8.5
Dphi(MET,ph): abs(ph_met_dphi) > 0.4
Z vertex: abs(ph_ZVtx < 250)
...
PhJetCR = (
         ...
         {"name": "ph_pt>150GeV", "cut": "(ph_pt > 150000. && abs(ph_eta2) <
2.37 && (abs(ph_eta2) < 1.37 || abs(ph_eta2) > 1.52))"},
         {"name": "DPhi(ph,MET)", "cut": "abs(ph_met_wmuon_dphi)>
0.4&&abs(ph_met_wmuon_dphi)<3"},
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   Float_t Eiso, Etrack, track_limit;
