...
#ifndef Selector_ABCDEF_h
#define Selector_ABCDEF_h
...
class Selector_ABCDEF : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   Int_t N_lepton_veto;
   Int_t N_TightIso;
   Int_t N_A, N_B, N_C, N_D, N_E, N_F;

   Float_t iso_leakage, iso_division, iso_limit;
   Float_t track_leakage, track_division, track_limit;
   ...
   ClassDef(Selector_ABCDEF,0);

};

#endif

#ifdef Selector_ABCDEF_cxx
void Selector_ABCDEF::Init(TTree *tree)
{
...
#endif // #ifdef Selector_ABCDEF_cxx
