#define Selector_ABCDEF_cxx
// The class definition in Selector_ABCDEF.h has been generated automatically
...
//
// root> T->Process("Selector_ABCDEF.C")
// root> T->Process("Selector_ABCDEF.C","some options")
// root> T->Process("Selector_ABCDEF.C+")
//


#include <Selector_ABCDEF.h>
#include <TH2.h>
#include <TStyle.h>
#include <iostream>
#include <TH1F.h>
...
void Selector_ABCDEF::Begin(TTree * /*tree*/)
{
   ...
   xbinning = new Double_t[intervallix+1];
   xbinning[0] = 0.;
   xbinning[1] = 1.;
   xbinning[2] = 2.;
   xbinning[3] = 3.;
   ...
   SR_H[0] = new TH2F("SR - ISR1","SR - ISR1",intervallix,xbinning,intervalliy,miny,maxy);
   SR_H[1] = new TH2F("SR - ISR2","SR - ISR2",intervallix,xbinning,intervalliy,miny,maxy);
   SR_H[2] = new TH2F("SR - ISR3","SR - ISR3",intervallix,xbinning,intervalliy,miny,maxy);
   SR_H[3] = new TH2F("SR - ESR1","SR - ESR1",intervallix,xbinning,intervalliy,miny,maxy);
   SR_H[4] = new TH2F("SR - ESR2","SR - ESR2",intervallix,xbinning,intervalliy,miny,maxy);

   oneMuCR_H[0] = new TH2F("1muCR - ISR1","1#muCR - ISR1",intervallix,xbinning,intervalliy,miny,maxy);
   oneMuCR_H[1] = new TH2F("1muCR - ISR2","1#muCR - ISR2",intervallix,xbinning,intervalliy,miny,maxy);
   oneMuCR_H[2] = new TH2F("1muCR - ISR3","1#muCR - ISR3",intervallix,xbinning,intervalliy,miny,maxy);
   oneMuCR_H[3] = new TH2F("1muCR - ESR1","1#muCR - ESR1",intervallix,xbinning,intervalliy,miny,maxy);
   oneMuCR_H[4] = new TH2F("1muCR - ESR2","1#muCR - ESR2",intervallix,xbinning,intervalliy,miny,maxy);

   twoMuCR_H[0] = new TH2F("2muCR - ISR1","2#muCR - ISR1",intervallix,xbinning,intervalliy,miny,maxy);
   twoMuCR_H[1] = new TH2F("2muCR - ISR2","2#muCR - ISR2",intervallix,xbinning,intervalliy,miny,maxy);
   twoMuCR_H[2] = new TH2F("2muCR - ISR3","2#muCR - ISR3",intervallix,xbinning,intervalliy,miny,maxy);
   twoMuCR_H[3] = new TH2F("2muCR - ESR1","2#muCR - ESR1",intervallix,xbinning,intervalliy,miny,maxy);
   twoMuCR_H[4] = new TH2F("2muCR - ESR2","2#muCR - ESR2",intervallix,xbinning,intervalliy,miny,maxy);

   twoECR_H[0] = new TH2F("2eCR - ISR1","2eCR - ISR1",intervallix,xbinning,intervalliy,miny,maxy);
   twoECR_H[1] = new TH2F("2eCR - ISR2","2eCR - ISR2",intervallix,xbinning,intervalliy,miny,maxy);
   twoECR_H[2] = new TH2F("2eCR - ISR3","2eCR - ISR3",intervallix,xbinning,intervalliy,miny,maxy);
   twoECR_H[3] = new TH2F("2eCR - ESR1","2eCR - ESR1",intervallix,xbinning,intervalliy,miny,maxy);
   twoECR_H[4] = new TH2F("2eCR - ESR2","2eCR - ESR2",intervallix,xbinning,intervalliy,miny,maxy);

   gammaJetCR_H = new TH2F("gammajetCR","#gamma + jet CR",intervallix,xbinning,intervalliy,miny,maxy);

   gammaJetCR_H->GetXaxis()->SetBinLabel(1., "Isolated");
   gammaJetCR_H->GetXaxis()->SetBinLabel(2., "Not Isolated");
   gammaJetCR_H->GetXaxis()->SetBinLabel(3., "Not Isolated");
   ...
   for(int i = 0; i < 4; i++) {
      ...
      */
      ...
      SR_H[i]->GetXaxis()->SetBinLabel(1., "Isolated");
      SR_H[i]->GetXaxis()->SetBinLabel(2., "Not Isolated");
      SR_H[i]->GetXaxis()->SetBinLabel(3., "Not Isolated");
      
      oneMuCR_H[i]->GetXaxis()->SetBinLabel(1., "Isolated");
      oneMuCR_H[i]->GetXaxis()->SetBinLabel(2., "Not Isolated");
      oneMuCR_H[i]->GetXaxis()->SetBinLabel(3., "Not Isolated");

      twoMuCR_H[i]->GetXaxis()->SetBinLabel(1., "Isolated");
      twoMuCR_H[i]->GetXaxis()->SetBinLabel(2., "Not Isolated");
      twoMuCR_H[i]->GetXaxis()->SetBinLabel(3., "Not Isolated");

      twoECR_H[i]->GetXaxis()->SetBinLabel(1., "Isolated");
      twoECR_H[i]->GetXaxis()->SetBinLabel(2., "Not Isolated");
      twoECR_H[i]->GetXaxis()->SetBinLabel(3., "Not Isolated");
...
void Selector_ABCDEF::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t Selector_ABCDEF::Process(Long64_t entry)
{
...
void Selector_ABCDEF::SlaveTerminate()
{
...
void Selector_ABCDEF::Terminate()
{
   ...
   cout << "____________________________________________________" << endl << endl;
   cout << "Popolazioni di SR - ESR1" << endl;
   cout << "____________________________________________________" << endl << endl;
   cout << "D\tC\tF" << endl;
   cout << N_D << "\t" << N_C << "\t" << N_F << endl;
   cout << N_A << "\t" << N_B << "\t" << N_E << endl;
   cout << "A\tB\tE" << endl;
   cout << "____________________________________________________" << endl << endl;

   cout << "Cacloli eseguiti con:" << endl;
   cout << "iso_leakage:    " << iso_leakage << endl;
   cout << "iso_division:   " << iso_division << endl;
   cout << "iso_limit:      " << iso_limit << endl;
   cout << "track_leakage:  " << track_leakage << endl;
   cout << "track_division: " << track_division << endl;
   cout << "track_limit:    " << track_limit << endl;
...
void Selector_ABCDEF::FillGraphs(TH2F **g, int i, Float_t met) {
   ...
   if (Eiso < 0. && Etrack < 0.05) xbin = 0.;
   else if ( (Eiso > iso_leakage && Eiso < iso_division && Etrack < track_division) || (Etrack > track_leakage && Etrack < track_division && Eiso < iso_leakage) )   xbin = 1.;
   else if ( (Eiso > iso_division && Eiso < iso_limit && Etrack < track_limit) || (Etrack > track_division && Etrack < track_limit && Eiso < iso_division) )         xbin = 2.;
   else return kFALSE;
...
*/   if(!pesati)weight = 1.;
   ...
   if (met > 150000.) {
      ...
      if ((!(ph_isEM[i] & tight4) && !ph_isTight[i]) && xbin == 0.)  N_A++;
      if ((!(ph_isEM[i] & tight4) && !ph_isTight[i]) && xbin == 1.)  N_B++;
      if (ph_isTight[i] && xbin == 1.)                               N_C++;
      if (ph_isTight[i] && xbin == 0.)                               N_D++;
      if ((!(ph_isEM[i] & tight4) && !ph_isTight[i]) && xbin == 2.)  N_E++;
      if (ph_isTight[i] && xbin == 2.)                               N_F++;
   }
...
void Selector_ABCDEF::FillGraphs(TH2F *g, int i) {
...
*/   if(!pesati)weight = 1.;
   ...
   if (ph_isTight[i])                               g -> Fill(xbin, bin_tight-1, weight);
