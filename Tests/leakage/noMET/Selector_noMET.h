...
#ifndef Selector_noMET_h
#define Selector_noMET_h
...
class Selector_noMET : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   Float_t weight, iso_limit, iso_max, track_limit, track_max;
   ...
   virtual void FillGraphs(Float_t** g, int i, Float_t pt);
   virtual void FillGraphs(Float_t* g, int i); 



   ClassDef(Selector_noMET,0);

};

#endif

#ifdef Selector_noMET_cxx
void Selector_noMET::Init(TTree *tree)
{
...
#endif // #ifdef Selector_noMET_cxx
