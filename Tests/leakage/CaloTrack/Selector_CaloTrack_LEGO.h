...
#ifndef Selector_CaloTrack_LEGO_h
#define Selector_CaloTrack_LEGO_h
...
class Selector_CaloTrack_LEGO : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   int intervallix, intervalliy;
   float minx, maxx, miny, maxy;


   int total, iso, not_iso, in_the_strip;
   float Ecalo, Etrack, weight;

   float track_limit;

   Selector_CaloTrack_LEGO(TTree * /*tree*/ =0) : 
      NumberOfEvents(0),
      N_trigger(0),
      N_met_tst_et(0),
      N_ph_pt(0),
   ...
   virtual ~Selector_CaloTrack_LEGO() { }
   ...
   virtual void FillGraphs(int i, Float_t met);
   virtual void FillGraphs(int i); 



   ClassDef(Selector_CaloTrack_LEGO,0);

};

#endif

#ifdef Selector_CaloTrack_LEGO_cxx
void Selector_CaloTrack_LEGO::Init(TTree *tree)
{
...
Bool_t Selector_CaloTrack_LEGO::Notify()
{
...
#endif // #ifdef Selector_CaloTrack_LEGO_cxx
