...
#ifndef Selector_CaloTrack_old_h
#define Selector_CaloTrack_old_h
...
class Selector_CaloTrack_old : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   Selector_CaloTrack_old(TTree * /*tree*/ =0) : 
      NumberOfEvents(0),
      N_trigger(0),
      N_met_tst_et(0),
      N_ph_pt(0),
   ...
   virtual ~Selector_CaloTrack_old() { }
   ...
   ClassDef(Selector_CaloTrack_old,0);

};

#endif

#ifdef Selector_CaloTrack_old_cxx
void Selector_CaloTrack_old::Init(TTree *tree)
{
...
Bool_t Selector_CaloTrack_old::Notify()
{
...
#endif // #ifdef Selector_CaloTrack_old_cxx
