...
#ifndef Selector_CaloTrack_h
#define Selector_CaloTrack_h
...
class Selector_CaloTrack : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   Float_t *track_limit;
   Float_t weight, iso_limit, iso_max, track_max;
   ...
   Selector_CaloTrack(TTree * /*tree*/ =0) : 
      NumberOfEvents(0),
      N_trigger(0),
      N_met_tst_et(0),
      N_ph_pt(0),
   ...
   virtual void FillGraphs(Float_t*** g, int i, Float_t met, int region);
   virtual void FillGraphs(Float_t** g, int i); 



   ClassDef(Selector_CaloTrack,0);

};

#endif

#ifdef Selector_CaloTrack_cxx
void Selector_CaloTrack::Init(TTree *tree)
{
...
Bool_t Selector_CaloTrack::Notify()
{
...
#endif // #ifdef Selector_CaloTrack_cxx
