...
#ifndef SelectorPesi_h
#define SelectorPesi_h
...
class SelectorPesi : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   Float_t weight, weightMin, weightMax;
   Int_t accettabili;
   ...
   ClassDef(SelectorPesi,0);

};

#endif

#ifdef SelectorPesi_cxx
void SelectorPesi::Init(TTree *tree)
{
