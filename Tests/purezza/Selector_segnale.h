...
#ifndef Selector_segnale_h
#define Selector_segnale_h
...
#define PATH_OUT "root_files/puro_segnale_pesato.root"
...
class Selector_segnale : public TSelector {
public :
...
//   TTreeReaderArray<float> ph_met_dphi = {fReader, "ph_met_dphi"};
   ...
   ClassDef(Selector_segnale,0);

};

#endif

#ifdef Selector_segnale_cxx
void Selector_segnale::Init(TTree *tree)
{
...
Bool_t Selector_segnale::Notify()
{
...
#endif // #ifdef Selector_segnale_cxx
